...
public class AnagramTest {
    ...
    public void testDetectMultipleAnagrams() {
        ...
        assertThat(detector.match(Arrays.asList("stream", "pigeon", "maters"))).containsExactlyInAnyOrder​("maters",
                "stream");
    }
    ...
    public void testDetectMultipleAnagramsForLongerWord() {
        ...
        assertThat(detector.match(Arrays.asList("gallery", "ballerina", "regally", "clergy", "largely", "leading")))

...
public class SeriesTest {
    ...
    public void slicesIncludeDuplicates() {
        ...
        List<String> expected = Arrays.asList("777", "777", "777", "777");
    ...
    public void slicesOfLongSeries() {
        ...
        List<String> expected = Arrays.asList("91849", "18493", "84939", "49390", "93904", "39042", "90424", "04243");
    ...
    public void sliceLengthIsToolarge() {
        ...
        IllegalArgumentException expected = assertThrows(IllegalArgumentException.class, () -> series.slices(6));

        assertThat(expected).hasMessage("Slice size is too big.");
    }
    ...
    public void sliceLengthZero() {
        ...
        IllegalArgumentException expected = assertThrows(IllegalArgumentException.class, () -> series.slices(0));

        assertThat(expected).hasMessage("Slice size is too small.");
    }
    ...
    public void sliceLengthNegative() {
        ...
        IllegalArgumentException expected = assertThrows(IllegalArgumentException.class, () -> series.slices(-1));
